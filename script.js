...
if (header) {
  ...
  header.innerHTML = `<div class="container nav"><a class="brand brand-wordmark" href="index.html" aria-label="AuraDigital ana sayfa"><img class="brand-logo" src="assets/logo.svg" alt="" aria-hidden="true"><strong>auradigital</strong></a><div class="nav-links" id="navLinks">${pages
    .map(
      ([id, href, label]) =>
