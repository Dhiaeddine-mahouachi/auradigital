(function () {
  const rows = [
    ...
    ["Tamamla.", "Done.", "تم."],
    [
      "Müşterinizin Google yorumu bırakmasını veya web sitenizi açmasını tek dokunuşa indirin. Renginizi, mesajınızı ve bağlantınızı seçin; kartı üretimden önce canlı görün.",
      "Make leaving a Google review or opening your website a one-tap action. Choose the colors, message and link, then preview the card before production.",
      "اجعل تقييم Google أو فتح موقعك بلمسة واحدة. اختر الألوان والرسالة والرابط وشاهد البطاقة قبل الإنتاج.",
    ],
    ["NFC kartınızı tasarlayın ↗", "Design your NFC card ↗", "صمّم بطاقة NFC ↗"],
    ["Nasıl çalıştığını görün", "See how it works", "شاهد كيف تعمل"],
    ...
    [
      "Google yorum sayfası veya işletmenizin web sitesi.",
      "Your Google review page or business website.",
      "صفحة تقييم Google أو موقع نشاطك.",
    ],
    ...
    ["Web Sitesi", "Website", "الموقع"],
    [
      "Ziyaretçiyi tek dokunuşla ana sayfanıza, kampanyanıza veya randevu sayfanıza yönlendirin.",
      "Send visitors to your home page, campaign or booking page with one tap.",
      "وجّه الزائر بلمسة واحدة إلى صفحتك الرئيسية أو حملتك أو صفحة الحجز.",
    ],
    ...
    ["Canlı tasarım stüdyosu", "Live design studio", "استوديو تصميم مباشر"],
    ["Renginizi seçin, kartınızı", "Choose your colors and", "اختر ألوانك وشاهد"],
    ["hemen görün.", "preview your card.", "بطاقتك فوراً."],
    [
      "Google yorum veya web sitesi kartınızı hazırlayın. Talebiniz panelimize kırmızı olarak gelir; ödeme ve onaydan sonra yeşile döner.",
      "Create a Google review or website card. Your request arrives red in our dashboard and turns green after payment and approval.",
      "أنشئ بطاقة تقييم Google أو موقع. يصل طلبك باللون الأحمر إلى لوحتنا ويصبح أخضر بعد الدفع والموافقة.",
    ],
    ["Kart tasarlamaya başlayın ↗", "Start designing your card ↗", "ابدأ تصميم بطاقتك ↗"],
    ["Toplu sipariş sorun", "Ask about bulk orders", "اسأل عن طلب الكمية"],
    [
    ...
    ["E-posta", "Email", "البريد الإلكتروني"],
    ...
    ["Diğer", "Other", "أخرى"],
    ["Talebi gönder ↗", "Send request ↗", "إرسال الطلب ←"],
    [
      "Talebiniz AuraDigital ekibine iletilir. Gönderimden sonra e-posta adresinize otomatik bir onay mesajı gönderilir.",
      "Your request is sent to the AuraDigital team. After submission, an automatic confirmation is sent to your email address.",
      "يتم إرسال طلبك إلى فريق AuraDigital، وبعد الإرسال ستصلك رسالة تأكيد تلقائية على بريدك الإلكتروني.",
    ],
    ...
    ["2 NET SEÇENEK", "2 CLEAR OPTIONS", "خياران واضحان"],
    ["Menüyü kim hazırlasın?", "Who should build your menu?", "من سيجهز قائمتك؟"],
    ["Seçilen tasarım", "Selected design", "التصميم المختار"],
    ["KENDİN OLUŞTUR", "BUILD IT YOURSELF", "أنشئها بنفسك"],
    [
      "Menüyü kendim oluşturacağım",
      "I’ll build the menu myself",
      "سأنشئ القائمة بنفسي",
    ],
    [
      "AuraMenu Studio'da ürünleri, fiyatları, fotoğrafları ve renkleri kendiniz düzenlersiniz.",
      "Use AuraMenu Studio to edit the products, prices, photos and colors yourself.",
      "استخدم استوديو AuraMenu لتعديل المنتجات والأسعار والصور والألوان بنفسك.",
    ],
    [
      "AuraMenu adresi · SSL dahil",
      "AuraMenu address · SSL included",
      "عنوان AuraMenu · شهادة SSL مشمولة",
    ],
    ["BİZ HAZIRLAYALIM", "LET US BUILD IT", "دعنا نجهزها"],
    [
      "AuraDigital benim için hazırlasın",
      "AuraDigital builds it for me",
      "لتجهزها AuraDigital لي",
    ],
    [
      "Seçtiğiniz tasarımı markanıza uyarlar, ürünlerinizi yerleştirir ve yayına hazırlarız.",
      "We adapt the selected design to your brand, add your products and prepare it for launch.",
      "نكيّف التصميم المختار مع علامتك ونضيف منتجاتك ونجهزه للنشر.",
    ],
    [
      "Özel alan adı sizin adınıza kaydedilir · SSL dahil",
      "Custom domain registered in your name · SSL included",
      "نطاق خاص مسجل باسمك · شهادة SSL مشمولة",
    ],
    [
      "SSL sertifikası iki seçenekte de dahildir.",
      "An SSL certificate is included with both options.",
      "شهادة SSL مشمولة في كلا الخيارين.",
    ],
    ["WhatsApp'tan gönder ↗", "Send via WhatsApp ↗", "إرسال عبر WhatsApp ↗"],
    ["700 TL'den başlayan", "Starting from 700 TL", "ابتداءً من 700 TL"],
    ["1.599 TL", "1,599 TL", "1,599 TL"],
