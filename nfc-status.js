(function () {
  ...
  function renderPayment(request){
    ...
    const total=Number(request.total)||PAYMENT.unitPrice*quantity;
    ...
    byId("paymentDeliveryLabel").textContent=text.deliveryLabel;byId("paymentDelivery").textContent=deliveryText(request);
